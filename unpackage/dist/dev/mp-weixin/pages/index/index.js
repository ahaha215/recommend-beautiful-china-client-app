...
/***/ 173:
/*!**************************************************************************************************************************************!*\
  !*** /Users/liting/Projects/recommend-beautiful-china/recommend-beautiful-china-client-app/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \**************************************************************************************************************************************/
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/index/index.vue */ 174));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/***/ 174:
/*!*******************************************************************************************************************!*\
  !*** /Users/liting/Projects/recommend-beautiful-china/recommend-beautiful-china-client-app/pages/index/index.vue ***!
  \*******************************************************************************************************************/
/*! no static exports found */
...
/***/ 175:
/*!**************************************************************************************************************************************************************!*\
  !*** /Users/liting/Projects/recommend-beautiful-china/recommend-beautiful-china-client-app/pages/index/index.vue?vue&type=template&id=57280228&scoped=true& ***!
  \**************************************************************************************************************************************************************/
...
try {
  components = {
    uSwiper: function() {
      return Promise.all(/*! import() | node-modules/uview-ui/components/u-swiper/u-swiper */[__webpack_require__.e("common/vendor"), __webpack_require__.e("node-modules/uview-ui/components/u-swiper/u-swiper")]).then(__webpack_require__.bind(null, /*! uview-ui/components/u-swiper/u-swiper.vue */ 278))
    }
  }
} catch (e) {
  if (
...
var render = function() {
  ...
  var l0 = _vm.__map(_vm.newScenicSpotData, function(scenicSpotItem, __i0__) {
    var $orig = _vm.__get_orig(scenicSpotItem)

    var m0 = _vm.formatTime(scenicSpotItem.gmtCreate)
    return {
      $orig: $orig,
      m0: m0
    }
...
/***/ 177:
/*!********************************************************************************************************************************************!*\
  !*** /Users/liting/Projects/recommend-beautiful-china/recommend-beautiful-china-client-app/pages/index/index.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 178:
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/liting/Projects/recommend-beautiful-china/recommend-beautiful-china-client-app/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//
//
var _default = { data: function data() {return { swipperData: [], newScenicSpotData: [], current: 0, limit: 10 };}, onLoad: function onLoad() {this.initSwiperData();this.initNewScenicSpotData();}, onPullDownRefresh: function onPullDownRefresh() {this.refreshData();}, methods: { initSwiperData: function initSwiperData() {var _this = this;this.$api.getSwiperData().then(function (response) {_this.swipperData = response.data.bannerList;});}, initNewScenicSpotData: function initNewScenicSpotData() {var _this2 = this;this.$api.getNewScenicSpotData("sortByCreateTime", this.current, this.limit).then(function (response) {_this2.newScenicSpotData = response.data.scenicSpotVOList;});}, refreshData: function refreshData() {this.initSwiperData();this.initNewScenicSpotData();uni.stopPullDownRefresh();}, gotoSeach: function gotoSeach() {uni.navigateTo({ url: "/pages/search/index" });}, formatTime: function formatTime(gmtCreate) {var date = new Date(gmtCreate);var seperator1 = "-";var seperator2 = ":";var month = date.getMonth() + 1;var strDate = date.getDate();if (month >= 1 && month <= 9) {month = "0" + month;}if (strDate >= 0 && strDate <= 9) {strDate = "0" + strDate;}var currentdate = date.getFullYear() + seperator1 + month + seperator1 + strDate + " " + date.getHours() + seperator2 + date.getMinutes() + seperator2 + date.getSeconds();return currentdate;} } };exports.default = _default;
...
/***/ 179:
/*!*****************************************************************************************************************************************************************************!*\
  !*** /Users/liting/Projects/recommend-beautiful-china/recommend-beautiful-china-client-app/pages/index/index.vue?vue&type=style&index=0&id=57280228&lang=scss&scoped=true& ***!
  \*****************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
